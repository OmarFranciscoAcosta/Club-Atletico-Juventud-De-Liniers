...
class partners (models.Model):
    ...
    fecha_vencimiento_apto_fisico = models.DateField ('Fecha de emisión del apto físico',null=True)
    fecha_vencimiento_fichaje = models.DateField ('Fecha de emisión del fichaje',null=True)
